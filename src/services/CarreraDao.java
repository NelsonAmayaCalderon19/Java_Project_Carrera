...
public class CarreraDao {
	...
	public void insertar(Carrera carrera){
		String sql = "INSERT INTO carrera (codigo, nombre, "
				+ "credito, semestre) VALUES('"+carrera.getCodigo()+"',"
				+ " '"+carrera.getNombre()+"', "
				+ "'"+carrera.getCredito()+"', "
				+ "'"+carrera.getSemestre()+"')";
	...
	public void actualizar(Carrera carrera){
		String sql = "UPDATE carrera SET "
				...
				+ "semestre = "+carrera.getSemestre()+", "
				+ "credito = "+carrera.getCredito()+" "
	...
	public Carrera buscar(String codigo){
		...
		try {
			...
			while(res.next()){
        	    carrera = new Carrera();
        	    carrera.setCodigo(res.getInt("codigo"));
        	    carrera.setNombre(res.getString("nombre"));
        	    carrera.setCredito(res.getInt("credito"));
        	    carrera.setSemestre(res.getInt("semestre"));
			}
	   	res.close();
